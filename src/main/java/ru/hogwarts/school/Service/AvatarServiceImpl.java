...
public class AvatarServiceImpl implements AvatarService {
    ...
    public void uploadAvatar(Long studentId, MultipartFile avatarFile) throws IOException {
        ...
        avatar.setPreview(cutImagineForDb(filePath));
    ...
    public Avatar getAvatar(Long id) {
        return avatarRepository.findById(id).orElseThrow(()-> new AvatarNotFoundException());
    }
    ...
    private byte[] cutImagineForDb(Path filePath) throws IOException {
